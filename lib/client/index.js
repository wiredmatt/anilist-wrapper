...
class Client {
    ...
    fetch(queryObj) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield axios_1.default
                ...
                else if (r.SaveMediaListEntry)
                    return r.SaveMediaListEntry.id;
                else if (r.DeleteMediaListEntry)
                    return r.DeleteMediaListEntry.deleted;
                else if (r.Page) {
    ...
    fetchUserAnimeList() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.userId)
                throw { error: "User must be authenticated." };
            yield this.fetch(queries_1.User.USER_ANIME_LIST(this.userId))
                .then((lists) => {
    ...
    fetchUserMangaList() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.userId)
                throw { error: "User must be authenticated." };
            yield this.fetch(queries_1.User.USER_MANGA_LIST(this.userId))
                .then((lists) => {
    ...
    animeDetails(anime) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Media.MediaDetails.ANIME_DETAILS(anime.id)).catch((err) => {
                throw err;
            });
    ...
    mangaDetails(manga) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Media.MediaDetails.MANGA_DETAILS(manga.id)).catch((err) => {
                throw err;
            });
    ...
    characterDetails(character) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Character.CHARACTER_DETAILS(character.id)).catch((err) => {
                throw err;
            });
    ...
    updateEntry(Args) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetch(mutations_1.Media.UPDATE_ENTRY(Args)).catch((err) => {
                throw err;
            });
            return response;
        });
    ...
    deleteEntry(entryId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetch(mutations_1.Media.DELETE_ENTRY(entryId)).catch((err) => {
                throw err;
            });
            return response;
        });
