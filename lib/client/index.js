...
class Client {
    ...
    animeDetails(anime) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Media.MediaDetails.ANIME_DETAILS(anime.id));
            return utils_1.extend(details, anime);
        });
    }
    mangaDetails(manga) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Media.MediaDetails.MANGA_DETAILS(manga.id));
    ...
    characterDetails(character) {
        return __awaiter(this, void 0, void 0, function* () {
            const details = yield this.fetch(queries_1.Character.CHARACTER_DETAILS(character.id));
