...
export declare type MEDIA_SEARCH_ARGS = {
    /** What to search for */
...
export declare type SeasonYear = {
    season: MediaSeason;
    year: Scalars['Int'];
};
...
export declare type QueryMediaTrendArgs = {
...
export declare type QueryAiringScheduleArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    episode?: Maybe<Scalars["Int"]>;
...
export declare type QueryCharacterArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
export declare type QueryStaffArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
export declare type QueryMediaListArgs = {
    id?: Maybe<Scalars["Int"]>;
...
export declare type QueryMediaListCollectionArgs = {
    userId?: Maybe<Scalars["Int"]>;
    userName?: Maybe<Scalars["String"]>;
    type?: Maybe<MediaType>;
    status?: Maybe<MediaListStatus>;
...
export declare type QueryMediaTagCollectionArgs = {
...
export declare type QueryStudioArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
export declare type QueryActivityArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
...
export declare type QueryActivityReplyArgs = {
    id?: Maybe<Scalars["Int"]>;
...
export declare type QueryFollowerArgs = {
    userId: Scalars["Int"];
    sort?: Maybe<Array<Maybe<UserSort>>>;
};
...
export declare type QueryThreadCommentArgs = {
    id?: Maybe<Scalars["Int"]>;
    threadId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<ThreadCommentSort>>>;
};
export declare type QueryRecommendationArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
...
export declare type QueryLikeArgs = {
...
/** Page of data */
export declare type PageUsersArgs = {
    id?: Maybe<Scalars["Int"]>;
    name?: Maybe<Scalars["String"]>;
    search?: Maybe<Scalars["String"]>;
    sort?: Maybe<Array<Maybe<UserSort>>>;
...
/** Page of data */
export declare type PageMediaArgs = {
    id?: Maybe<Scalars["Int"]>;
    idMal?: Maybe<Scalars["Int"]>;
    startDate?: Maybe<Scalars["FuzzyDateInt"]>;
    endDate?: Maybe<Scalars["FuzzyDateInt"]>;
...
/** Page of data */
export declare type PageCharactersArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data */
export declare type PageStaffArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data */
export declare type PageStudiosArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data */
export declare type PageMediaListArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    userName?: Maybe<Scalars["String"]>;
    type?: Maybe<MediaType>;
...
/** Page of data */
export declare type PageAiringSchedulesArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    episode?: Maybe<Scalars["Int"]>;
    airingAt?: Maybe<Scalars["Int"]>;
...
/** Page of data */
export declare type PageMediaTrendsArgs = {
    mediaId?: Maybe<Scalars["Int"]>;
    date?: Maybe<Scalars["Int"]>;
    trending?: Maybe<Scalars["Int"]>;
    averageScore?: Maybe<Scalars["Int"]>;
...
/** Page of data */
export declare type PageNotificationsArgs = {
    type?: Maybe<NotificationType>;
    resetNotificationCount?: Maybe<Scalars["Boolean"]>;
    type_in?: Maybe<Array<Maybe<NotificationType>>>;
};
/** Page of data */
export declare type PageFollowersArgs = {
    userId: Scalars["Int"];
    sort?: Maybe<Array<Maybe<UserSort>>>;
};
/** Page of data */
export declare type PageFollowingArgs = {
    userId: Scalars["Int"];
    sort?: Maybe<Array<Maybe<UserSort>>>;
};
/** Page of data */
export declare type PageActivitiesArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    messengerId?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
...
/** Page of data */
export declare type PageActivityRepliesArgs = {
    id?: Maybe<Scalars["Int"]>;
    activityId?: Maybe<Scalars["Int"]>;
};
/** Page of data */
export declare type PageThreadsArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    replyUserId?: Maybe<Scalars["Int"]>;
    subscribed?: Maybe<Scalars["Boolean"]>;
...
/** Page of data */
export declare type PageThreadCommentsArgs = {
    id?: Maybe<Scalars["Int"]>;
    threadId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<ThreadCommentSort>>>;
...
/** Page of data */
export declare type PageReviewsArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    mediaType?: Maybe<MediaType>;
...
/** Page of data */
export declare type PageRecommendationsArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    mediaRecommendationId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
...
/** Page of data */
export declare type PageLikesArgs = {
    likeableId?: Maybe<Scalars["Int"]>;
    type?: Maybe<LikeableType>;
};
...
/** A user */
export declare type UserAboutArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** A user */
export declare type UserFavouritesArgs = {
...
/** The language the user wants to see media titles in */
export declare enum UserTitleLanguage {
...
export declare type MediaListOptions = {
...
export declare enum ScoreFormat {
...
export declare type MediaListTypeOptions = {
...
export declare type Favourites = {
...
/** User's favourite anime, manga, characters, staff & studios */
export declare type FavouritesAnimeArgs = {
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** User's favourite anime, manga, characters, staff & studios */
export declare type FavouritesMangaArgs = {
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** User's favourite anime, manga, characters, staff & studios */
export declare type FavouritesCharactersArgs = {
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** User's favourite anime, manga, characters, staff & studios */
export declare type FavouritesStaffArgs = {
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** User's favourite anime, manga, characters, staff & studios */
export declare type FavouritesStudiosArgs = {
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
...
/** Media connection edge */
export declare type MediaEdgeRelationTypeArgs = {
    version?: Maybe<Scalars["Int"]>;
};
/** Media connection edge */
export declare type MediaEdgeVoiceActorsArgs = {
...
/** Anime or Manga */
export declare type MediaStatusArgs = {
    version?: Maybe<Scalars["Int"]>;
};
/** Anime or Manga */
export declare type MediaDescriptionArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Anime or Manga */
export declare type MediaSourceArgs = {
    version?: Maybe<Scalars["Int"]>;
};
/** Anime or Manga */
export declare type MediaCharactersArgs = {
    sort?: Maybe<Array<Maybe<CharacterSort>>>;
...
/** Anime or Manga */
export declare type MediaStaffArgs = {
    sort?: Maybe<Array<Maybe<StaffSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** Anime or Manga */
export declare type MediaStudiosArgs = {
    sort?: Maybe<Array<Maybe<StudioSort>>>;
    isMain?: Maybe<Scalars["Boolean"]>;
};
/** Anime or Manga */
export declare type MediaAiringScheduleArgs = {
    notYetAired?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** Anime or Manga */
export declare type MediaTrendsArgs = {
    sort?: Maybe<Array<Maybe<MediaTrendSort>>>;
    releasing?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
...
/** Anime or Manga */
export declare type MediaReviewsArgs = {
...
/** Anime or Manga */
export declare type MediaRecommendationsArgs = {
    sort?: Maybe<Array<Maybe<RecommendationSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** The official titles of the media in various languages */
export declare type MediaTitle = {
...
/** The official titles of the media in various languages */
export declare type MediaTitleRomajiArgs = {
    stylised?: Maybe<Scalars["Boolean"]>;
};
/** The official titles of the media in various languages */
export declare type MediaTitleEnglishArgs = {
    stylised?: Maybe<Scalars["Boolean"]>;
};
/** The official titles of the media in various languages */
export declare type MediaTitleNativeArgs = {
    stylised?: Maybe<Scalars["Boolean"]>;
};
...
export declare enum MediaSeason {
...
/** Media trailer or advertisement */
export declare type MediaTrailer = {
...
export declare type MediaCoverImage = {
...
export declare type CharacterConnection = {
...
export declare type CharacterEdge = {
...
/** Character connection edge */
export declare type CharacterEdgeVoiceActorsArgs = {
    language?: Maybe<StaffLanguage>;
    sort?: Maybe<Array<Maybe<StaffSort>>>;
};
...
/** A character that features in an anime or manga */
export declare type CharacterDescriptionArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** A character that features in an anime or manga */
export declare type CharacterMediaArgs = {
    sort?: Maybe<Array<Maybe<MediaSort>>>;
    type?: Maybe<MediaType>;
    onList?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
...
/** The names of the character */
export declare type CharacterName = {
...
export declare type CharacterImage = {
...
export declare enum StaffLanguage {
    /** Japanese */
    Japanese = "JAPANESE",
    /** English */
    English = "ENGLISH",
...
/** Voice actors or production staff */
export declare type StaffDescriptionArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Voice actors or production staff */
export declare type StaffStaffMediaArgs = {
    sort?: Maybe<Array<Maybe<MediaSort>>>;
    type?: Maybe<MediaType>;
    onList?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
...
/** Voice actors or production staff */
export declare type StaffCharactersArgs = {
    sort?: Maybe<Array<Maybe<CharacterSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** Voice actors or production staff */
export declare type StaffCharacterMediaArgs = {
    sort?: Maybe<Array<Maybe<MediaSort>>>;
    onList?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
...
export declare type StaffImage = {
...
export declare type StaffConnection = {
...
/** Studio sort enums */
export declare enum StudioSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    Name = "NAME",
    NameDesc = "NAME_DESC",
...
export declare type StudioConnection = {
...
export declare type StudioEdge = {
...
/** Animation or production company */
export declare type StudioMediaArgs = {
    sort?: Maybe<Array<Maybe<MediaSort>>>;
    isMain?: Maybe<Scalars["Boolean"]>;
    onList?: Maybe<Scalars["Boolean"]>;
    page?: Maybe<Scalars["Int"]>;
...
export declare type AiringSchedule = {
...
export declare type AiringScheduleConnection = {
...
export declare type AiringScheduleEdge = {
...
export declare enum MediaTrendSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    MediaId = "MEDIA_ID",
...
export declare type MediaTrendConnection = {
...
export declare type MediaTrendEdge = {
    __typename?: "MediaTrendEdge";
    node?: Maybe<MediaTrend>;
};
/** Daily media statistics */
export declare type MediaTrend = {
...
export declare type MediaExternalLink = {
...
/** Data and links to legal streaming episodes on external sites */
export declare type MediaStreamingEpisode = {
...
/** The type of ranking */
export declare enum MediaRankType {
...
/** List of anime or manga */
export declare type MediaListScoreArgs = {
    format?: Maybe<ScoreFormat>;
};
/** List of anime or manga */
export declare type MediaListCustomListsArgs = {
...
/** Review sort enums */
export declare enum ReviewSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    Score = "SCORE",
    ScoreDesc = "SCORE_DESC",
...
export declare type ReviewEdge = {
...
/** A Review that features in an anime or manga */
export declare type ReviewBodyArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Review rating enums */
...
export declare enum RecommendationSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    Rating = "RATING",
    RatingDesc = "RATING_DESC"
}
export declare type RecommendationConnection = {
...
export declare type RecommendationEdge = {
...
export declare enum RecommendationRating {
    NoRating = "NO_RATING",
    RateUp = "RATE_UP",
    RateDown = "RATE_DOWN"
}
...
export declare type ScoreDistribution = {
...
export declare type StatusDistribution = {
...
export declare type AiringProgression = {
...
export declare type UserStatisticTypes = {
...
export declare type UserStatisticsFormatsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsStatusesArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsScoresArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsLengthsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsReleaseYearsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsStartYearsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsGenresArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsTagsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsCountriesArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsVoiceActorsArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsStaffArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
export declare type UserStatisticsStudiosArgs = {
    limit?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<UserStatisticsSort>>>;
};
/** User statistics sort enum */
export declare enum UserStatisticsSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    Count = "COUNT",
...
export declare type UserFormatStatistic = {
...
export declare type UserStatusStatistic = {
...
export declare type UserScoreStatistic = {
...
export declare type UserLengthStatistic = {
...
export declare type UserReleaseYearStatistic = {
...
export declare type UserStartYearStatistic = {
...
export declare type UserGenreStatistic = {
...
export declare type UserTagStatistic = {
...
export declare type UserCountryStatistic = {
...
export declare type UserVoiceActorStatistic = {
...
export declare type UserStaffStatistic = {
...
export declare type UserStudioStatistic = {
...
export declare type UserActivityHistory = {
...
export declare type ListScoreStats = {
    __typename?: "ListScoreStats";
    meanScore?: Maybe<Scalars["Int"]>;
    standardDeviation?: Maybe<Scalars["Int"]>;
};
/** User's genre statistics */
export declare type GenreStats = {
...
export declare type StaffStats = {
...
export declare type StudioStats = {
...
export declare type FormatStats = {
    __typename?: "FormatStats";
    format?: Maybe<MediaFormat>;
    amount?: Maybe<Scalars["Int"]>;
};
/** Media list sort enums */
export declare enum MediaListSort {
    MediaId = "MEDIA_ID",
    MediaIdDesc = "MEDIA_ID_DESC",
    Score = "SCORE",
    ScoreDesc = "SCORE_DESC",
...
export declare enum AiringSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    MediaId = "MEDIA_ID",
    MediaIdDesc = "MEDIA_ID_DESC",
...
export declare type FollowingNotification = {
...
export declare type ActivityMessageNotification = {
...
/** User message activity */
export declare type MessageActivityMessageArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Activity type enum. */
...
export declare type ActivityReply = {
...
/** Replay to an activity item */
export declare type ActivityReplyTextArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Notification for when authenticated user is @ mentioned in activity or reply */
export declare type ActivityMentionNotification = {
...
/** Activity union type */
export declare type ActivityUnion = TextActivity | ListActivity | MessageActivity;
/** User text activity */
export declare type TextActivity = {
...
/** User text activity */
export declare type TextActivityTextArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** User list activity (anime & manga updates) */
export declare type ListActivity = {
...
export declare type ActivityReplyNotification = {
...
export declare type ActivityReplySubscribedNotification = {
...
export declare type ActivityLikeNotification = {
...
export declare type ActivityReplyLikeNotification = {
...
export declare type ThreadCommentMentionNotification = {
...
/** Forum Thread */
export declare type ThreadBodyArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** A forum thread category */
export declare type ThreadCategory = {
...
export declare type ThreadComment = {
...
/** Forum Thread Comment */
export declare type ThreadCommentCommentArgs = {
    asHtml?: Maybe<Scalars["Boolean"]>;
};
/** Notification for when a user replies to your forum thread comment */
export declare type ThreadCommentReplyNotification = {
...
export declare type ThreadCommentSubscribedNotification = {
...
export declare type ThreadCommentLikeNotification = {
...
export declare type ThreadLikeNotification = {
...
export declare type RelatedMediaAdditionNotification = {
...
/** Activity sort enums */
export declare enum ActivitySort {
    Id = "ID",
    IdDesc = "ID_DESC"
}
/** Thread sort enums */
export declare enum ThreadSort {
    Id = "ID",
    IdDesc = "ID_DESC",
    Title = "TITLE",
...
export declare enum ThreadCommentSort {
    Id = "ID",
    IdDesc = "ID_DESC"
}
...
/** List of anime or manga */
export declare type MediaListCollection = {
    __typename?: "MediaListCollection";
    /** Grouped media list entries */
    lists?: Maybe<Array<MediaListGroup>>;
...
/** List of anime or manga */
export declare type MediaListCollectionStatusListsArgs = {
    asArray?: Maybe<Scalars["Boolean"]>;
};
/** List of anime or manga */
export declare type MediaListCollectionCustomListsArgs = {
    asArray?: Maybe<Scalars["Boolean"]>;
};
/** List group of anime or manga entries */
export declare type MediaListGroup = {
...
export declare type ParsedMarkdown = {
    __typename?: "ParsedMarkdown";
    /** The parsed markdown as html */
    html?: Maybe<Scalars["String"]>;
};
export declare type AniChartUser = {
    __typename?: "AniChartUser";
    user?: Maybe<User>;
    settings?: Maybe<Scalars["Json"]>;
    highlights?: Maybe<Scalars["Json"]>;
};
export declare type SiteStatistics = {
...
export declare type SiteStatisticsUsersArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsAnimeArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsMangaArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsCharactersArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsStaffArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsStudiosArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
export declare type SiteStatisticsReviewsArgs = {
    sort?: Maybe<Array<Maybe<SiteTrendSort>>>;
    page?: Maybe<Scalars["Int"]>;
    perPage?: Maybe<Scalars["Int"]>;
};
/** Site trend sort enums */
export declare enum SiteTrendSort {
    Date = "DATE",
    DateDesc = "DATE_DESC",
    Count = "COUNT",
    CountDesc = "COUNT_DESC",
...
export declare type SiteTrendConnection = {
...
export declare type SiteTrendEdge = {
    __typename?: "SiteTrendEdge";
    node?: Maybe<SiteTrend>;
};
/** Daily site statistics */
export declare type SiteTrend = {
...
export declare type MutationUpdateMediaListEntriesArgs = {
    status?: Maybe<MediaListStatus>;
    score?: Maybe<Scalars["Float"]>;
    scoreRaw?: Maybe<Scalars["Int"]>;
    progress?: Maybe<Scalars["Int"]>;
...
export declare type MutationDeleteMediaListEntryArgs = {
    id?: Maybe<Scalars["Int"]>;
};
export declare type MutationDeleteCustomListArgs = {
    customList?: Maybe<Scalars["String"]>;
    type?: Maybe<MediaType>;
};
export declare type MutationSaveTextActivityArgs = {
    id?: Maybe<Scalars["Int"]>;
    text?: Maybe<Scalars["String"]>;
    locked?: Maybe<Scalars["Boolean"]>;
};
export declare type MutationSaveMessageActivityArgs = {
    id?: Maybe<Scalars["Int"]>;
    message?: Maybe<Scalars["String"]>;
    recipientId?: Maybe<Scalars["Int"]>;
    private?: Maybe<Scalars["Boolean"]>;
...
export declare type MutationSaveListActivityArgs = {
    id?: Maybe<Scalars["Int"]>;
    locked?: Maybe<Scalars["Boolean"]>;
};
export declare type MutationDeleteActivityArgs = {
    id?: Maybe<Scalars["Int"]>;
};
export declare type MutationToggleActivitySubscriptionArgs = {
    activityId?: Maybe<Scalars["Int"]>;
    subscribe?: Maybe<Scalars["Boolean"]>;
};
export declare type MutationSaveActivityReplyArgs = {
    id?: Maybe<Scalars["Int"]>;
    activityId?: Maybe<Scalars["Int"]>;
    text?: Maybe<Scalars["String"]>;
    asMod?: Maybe<Scalars["Boolean"]>;
};
export declare type MutationDeleteActivityReplyArgs = {
    id?: Maybe<Scalars["Int"]>;
};
export declare type MutationToggleLikeArgs = {
    id?: Maybe<Scalars["Int"]>;
    type?: Maybe<LikeableType>;
};
export declare type MutationToggleLikeV2Args = {
    id?: Maybe<Scalars["Int"]>;
    type?: Maybe<LikeableType>;
};
...
export declare type MutationToggleFavouriteArgs = {
...
export declare type MutationUpdateFavouriteOrderArgs = {
...
export declare type MutationSaveReviewArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    body?: Maybe<Scalars["String"]>;
    summary?: Maybe<Scalars["String"]>;
...
export declare type MutationRateReviewArgs = {
    reviewId?: Maybe<Scalars["Int"]>;
    rating?: Maybe<ReviewRating>;
};
export declare type MutationSaveRecommendationArgs = {
    mediaId?: Maybe<Scalars["Int"]>;
    mediaRecommendationId?: Maybe<Scalars["Int"]>;
    rating?: Maybe<RecommendationRating>;
};
export declare type MutationSaveThreadArgs = {
    id?: Maybe<Scalars["Int"]>;
    title?: Maybe<Scalars["String"]>;
    body?: Maybe<Scalars["String"]>;
...
export declare type MutationToggleThreadSubscriptionArgs = {
    threadId?: Maybe<Scalars["Int"]>;
    subscribe?: Maybe<Scalars["Boolean"]>;
};
export declare type MutationSaveThreadCommentArgs = {
    id?: Maybe<Scalars["Int"]>;
    threadId?: Maybe<Scalars["Int"]>;
    parentCommentId?: Maybe<Scalars["Int"]>;
    comment?: Maybe<Scalars["String"]>;
};
export declare type MutationDeleteThreadCommentArgs = {
    id?: Maybe<Scalars["Int"]>;
};
export declare type MutationUpdateAniChartSettingsArgs = {
    titleLanguage?: Maybe<Scalars["String"]>;
    outgoingLinkProvider?: Maybe<Scalars["String"]>;
    theme?: Maybe<Scalars["String"]>;
    sort?: Maybe<Scalars["String"]>;
};
export declare type MutationUpdateAniChartHighlightsArgs = {
    highlights?: Maybe<Array<Maybe<AniChartHighlightInput>>>;
};
/** Notification option input */
export declare type NotificationOptionInput = {
    /** The type of notification */
    type?: Maybe<NotificationType>;
    /** Whether this type of notification is enabled */
    enabled?: Maybe<Scalars["Boolean"]>;
...
/** A user's list options for anime or manga lists */
export declare type MediaListOptionsInput = {
    /** The order each list should be displayed in */
    sectionOrder?: Maybe<Array<Maybe<Scalars["String"]>>>;
    /** If the completed sections of the list should be separated by format */
    splitCompletedSectionByFormat?: Maybe<Scalars["Boolean"]>;
...
/** Date object that allows for incomplete date values (fuzzy) */
export declare type FuzzyDateInput = {
    /** Numeric Year (2017) */
    year?: Maybe<Scalars["Int"]>;
    /** Numeric Month (3) */
    month?: Maybe<Scalars["Int"]>;
...
/** Likeable union type */
export declare type LikeableUnion = ListActivity | TextActivity | MessageActivity | ActivityReply | Thread | ThreadComment;
export declare type AniChartHighlightInput = {
    mediaId?: Maybe<Scalars["Int"]>;
    highlight?: Maybe<Scalars["String"]>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPage = {
...
/** Page of data (Used for internal use only) */
export declare type InternalPageMediaSubmissionsArgs = {
    mediaId?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageCharacterSubmissionsArgs = {
    characterId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    status?: Maybe<SubmissionStatus>;
    sort?: Maybe<Array<Maybe<SubmissionSort>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageStaffSubmissionsArgs = {
    staffId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    status?: Maybe<SubmissionStatus>;
    sort?: Maybe<Array<Maybe<SubmissionSort>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageRevisionHistoryArgs = {
    userId?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    characterId?: Maybe<Scalars["Int"]>;
    staffId?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageModActionsArgs = {
    userId?: Maybe<Scalars["Int"]>;
    modId?: Maybe<Scalars["Int"]>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPageUsersArgs = {
    id?: Maybe<Scalars["Int"]>;
    name?: Maybe<Scalars["String"]>;
    search?: Maybe<Scalars["String"]>;
    sort?: Maybe<Array<Maybe<UserSort>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageMediaArgs = {
    id?: Maybe<Scalars["Int"]>;
    idMal?: Maybe<Scalars["Int"]>;
    startDate?: Maybe<Scalars["FuzzyDateInt"]>;
    endDate?: Maybe<Scalars["FuzzyDateInt"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageCharactersArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageStaffArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageStudiosArgs = {
    id?: Maybe<Scalars["Int"]>;
    search?: Maybe<Scalars["String"]>;
    id_not?: Maybe<Scalars["Int"]>;
    id_in?: Maybe<Array<Maybe<Scalars["Int"]>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageMediaListArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    userName?: Maybe<Scalars["String"]>;
    type?: Maybe<MediaType>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageAiringSchedulesArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    episode?: Maybe<Scalars["Int"]>;
    airingAt?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageMediaTrendsArgs = {
    mediaId?: Maybe<Scalars["Int"]>;
    date?: Maybe<Scalars["Int"]>;
    trending?: Maybe<Scalars["Int"]>;
    averageScore?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageNotificationsArgs = {
    type?: Maybe<NotificationType>;
    resetNotificationCount?: Maybe<Scalars["Boolean"]>;
    type_in?: Maybe<Array<Maybe<NotificationType>>>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPageFollowersArgs = {
    userId: Scalars["Int"];
    sort?: Maybe<Array<Maybe<UserSort>>>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPageFollowingArgs = {
    userId: Scalars["Int"];
    sort?: Maybe<Array<Maybe<UserSort>>>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPageActivitiesArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    messengerId?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageActivityRepliesArgs = {
    id?: Maybe<Scalars["Int"]>;
    activityId?: Maybe<Scalars["Int"]>;
};
/** Page of data (Used for internal use only) */
export declare type InternalPageThreadsArgs = {
    id?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    replyUserId?: Maybe<Scalars["Int"]>;
    subscribed?: Maybe<Scalars["Boolean"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageThreadCommentsArgs = {
    id?: Maybe<Scalars["Int"]>;
    threadId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    sort?: Maybe<Array<Maybe<ThreadCommentSort>>>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageReviewsArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
    mediaType?: Maybe<MediaType>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageRecommendationsArgs = {
    id?: Maybe<Scalars["Int"]>;
    mediaId?: Maybe<Scalars["Int"]>;
    mediaRecommendationId?: Maybe<Scalars["Int"]>;
    userId?: Maybe<Scalars["Int"]>;
...
/** Page of data (Used for internal use only) */
export declare type InternalPageLikesArgs = {
    likeableId?: Maybe<Scalars["Int"]>;
    type?: Maybe<LikeableType>;
};
/** Submission status */
...
export declare enum SubmissionSort {
    Id = "ID",
    IdDesc = "ID_DESC"
}
/** Media submission */
export declare type MediaSubmission = {
...
export declare type MediaSubmissionComparison = {
...
export declare type MediaSubmissionEdge = {
...
export declare type MediaCharacter = {
...
export declare type CharacterSubmission = {
...
export declare type StaffSubmission = {
...
export declare type RevisionHistory = {
...
export declare enum RevisionHistoryAction {
    Create = "CREATE",
    Edit = "EDIT"
}
...
/** The official titles of the media in various languages */
export declare type MediaTitleInput = {
    /** The romanization of the native language title */
    romaji?: Maybe<Scalars["String"]>;
    /** The official english title */
    english?: Maybe<Scalars["String"]>;
...
/** An external link to another site related to the media */
export declare type MediaExternalLinkInput = {
    /** The id of the external link */
    id: Scalars["Int"];
    /** The url of the external link */
    url: Scalars["String"];
...
export declare type AiringScheduleInput = {
    airingAt?: Maybe<Scalars["Int"]>;
    episode?: Maybe<Scalars["Int"]>;
    timeUntilAiring?: Maybe<Scalars["Int"]>;
};
/** The names of the character */
export declare type CharacterNameInput = {
    /** The character's given name */
    first?: Maybe<Scalars["String"]>;
    /** The character's surname */
    last?: Maybe<Scalars["String"]>;
...
export declare type CharacterSubmissionConnection = {
...
export declare type CharacterSubmissionEdge = {
...
/** The names of the staff member */
export declare type StaffNameInput = {
    /** The person's given name */
    first?: Maybe<Scalars["String"]>;
    /** The person's surname */
    last?: Maybe<Scalars["String"]>;
...
export declare type UserModData = {
